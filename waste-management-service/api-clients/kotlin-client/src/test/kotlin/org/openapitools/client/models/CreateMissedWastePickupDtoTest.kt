...
class CreateMissedWastePickupDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateMissedWastePickupDto
        //val modelInstance = CreateMissedWastePickupDto()
